...
ENa=50.0;  %55.17 mv Na reversal potential
EK=-77; % -72.14 mv K reversal potential
El=-54.6; %-49.42 mv Leakage reversal potential
gbarNa=120; %1.2 mS/cm^2 Na conductance
gbarK=36; % 0.36 mS/cm^2 K conductance
gbarl=0.3; %0.003 mS/cm^2 Leakage conductance
gbarsyn=0.04; %4*10^(-5)S second edit
tau=5.0; %second edit
Esyn=0; %mv second edit inhibitory
